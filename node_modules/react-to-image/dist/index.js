...
function useToImage(_temp, callback) {
  ...
  return _extends({}, state, {
    ref: ref || setRef,
    getSvg: defaultGetter(htmlToImage.toSvg, 'dataURL', 'svg'),
    getJpeg: defaultGetter(htmlToImage.toJpeg, 'dataURL', 'jpeg'),
    getPng: defaultGetter(htmlToImage.toPng, 'dataURL', 'png'),
    getBlob: defaultGetter(htmlToImage.toBlob, 'dataURL', 'png'),
    getPixelData: defaultGetter(htmlToImage.toPixelData, 'dataURL', 'svg'),
    getCanvas: defaultGetter(htmlToImage.toCanvas, 'dataURL', 'svg')
  });
}

exports.useToImage = useToImage;
